...
import authorization from "models/authorizantion.js";

describe("models/authorizantion.js", () => {
  describe(".can", () => {
    test("without `user`", () => {
      expect(() => {
        authorization.can();
  ...
  describe(".filterOutput", () => {
    ...
    test("with valid `user`, known `feature` and `resource`", () => {
      ...
      const resource = {
        ...
        username: "Resource",
        features: ["read:user"],
        created_at: "2026-02-06T22:40:19.931Z",
        updated_at: "2026-02-06T22:40:19.930Z",
        email: "resource@resoucer.com",
        password: "resource",
      };
